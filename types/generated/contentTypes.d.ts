...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    displayName: 'Categorias de productos';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    complementTextCategories: Schema.Attribute.String;
    corporativeText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    messageSocialMedia: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Subtitulo: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'cambia tu vida con nuestros suplementos naturales, dise\u00F1ados para mejorar tu bienestar y vitalidad. Descubre c\u00F3mo nuestros productos pueden ayudarte a alcanzar una vida m\u00E1s saludable y equilibrada.'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    benefits: Schema.Attribute.Component<'shared.product-benefits', true>;
    buttonProduct: Schema.Attribute.DynamicZone<
      ['shared.button', 'shared.icons']
    >;
    ...
    compositionProd: Schema.Attribute.Component<
      ...
      true
    >;
    consumeProd: Schema.Attribute.Component<
      'shared.consumo-del-producto',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descBenefits: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    presentationAndPrice: Schema.Attribute.Component<
